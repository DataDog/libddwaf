...
std::pmr::memory_resource *get_local_memory_resource() { return local_memory_resource; }

void set_local_memory_resource(std::pmr::memory_resource *mr) { local_memory_resource = mr; }
