...
public:
    ...
    [[nodiscard]] iterator begin() const
    {
        ...
        return iterator{obj_->via.array.ptr, obj_->via.array.ptr + obj_->via.array.size};
    }
    [[nodiscard]] iterator end() const
    {
        ...
        return iterator{
            obj_->via.array.ptr + obj_->via.array.size, obj_->via.array.ptr + obj_->via.array.size};
    }
...
public:
    ...
    [[nodiscard]] iterator begin() const
    {
        ...
        return iterator{obj_->via.map.ptr, obj_->via.map.ptr + obj_->via.map.size};
    }
    [[nodiscard]] iterator end() const
    {
        if (obj_ == nullptr) {
        ...
        return iterator{
            obj_->via.map.ptr + obj_->via.map.size, obj_->via.map.ptr + obj_->via.map.size};
    }
