...
class literal_object : public base_object<literal_object> {
public:
    literal_object() = default;
    ~literal_object() = default;

    literal_object(const literal_object &) = delete;
    literal_object &operator=(const literal_object &) = delete;

    literal_object(literal_object &&other) noexcept : obj_(other.obj_)
    {
        other.obj_ = detail::object{};
    }

    literal_object &operator=(literal_object &&other) noexcept
    {
        obj_ = other.obj_;
        other.obj_ = detail::object{};
        return *this;
    ...
    static literal_object make_null()
    {
        return literal_object{{.parameterName = nullptr,
            .parameterNameLength = 0,
            .stringValue = nullptr,
            .nbEntries = 0,
            .type = DDWAF_OBJ_NULL}};
    ...
    static literal_object make_boolean(bool value)
    {
        return literal_object{{.parameterName = nullptr,
            .parameterNameLength = 0,
            .boolean = value,
    ...
    static literal_object make_signed(int64_t value)
    {
        return literal_object{{.parameterName = nullptr,
            .parameterNameLength = 0,
            .intValue = value,
    ...
    static literal_object make_unsigned(uint64_t value)
    {
        return literal_object{{.parameterName = nullptr,
            .parameterNameLength = 0,
            .uintValue = value,
    ...
    static literal_object make_float(double value)
    {
        return literal_object{{.parameterName = nullptr,
            .parameterNameLength = 0,
            .f64 = value,
    ...
    static literal_object make_string_nocopy(const char *str, std::size_t len)
    {
        return literal_object{{.parameterName = nullptr,
            .parameterNameLength = 0,
            .stringValue = str,
    ...
    template <typename T>
    static literal_object make_string_nocopy(T str)
        requires std::is_same_v<T, std::string_view> || std::is_same_v<T, object_key>
    {
...
protected:
    explicit literal_object(detail::object obj) : obj_(obj) {}
