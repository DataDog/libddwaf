...
Additionally, consumers of the published binaries should note that 1) support
for i386 and armv7 was dropped and 2) when using the static library on Linux,
libm is now a dependency and should be included in the link line.
