    ...
    match_path_and_input(
        {
            ...
            {"https://home.localhost.me",
                {.yaml = "", .address = "", .highlight = "https://home.localhost.me"}},
            {"https://localhost.me",
                {.yaml = "", .address = "", .highlight = "https://localhost.me"}},
    ...
    match_path_and_input(
        {
            // Forbidden IP
            {"https://169.254.169.254/somewhere/in/the/app",
                {.yaml = "", .resolved = "https://169.254.169.254"}},
            {"ftp://127.0.0.1/not/found?test=true", {.yaml = "", .resolved = "ftp://127.0.0.1"}},
            {"ftps://10.25.26.27/", {.yaml = "", .resolved = "ftps://10.25.26.27"}},
            {"ftps://172.16.2.3/local", {.yaml = "", .resolved = "ftps://172.16.2.3"}},
            {"ftps://192.168.2.3/config", {.yaml = "", .resolved = "ftps://192.168.2.3"}},
            {"ftps://100.64.123.33/etc/passwd", {.yaml = "", .resolved = "ftps://100.64.123.33"}},
            {"https://[::ffff:a9fe:a9fe]/path",
                {.yaml = "", .resolved = "https://[::ffff:a9fe:a9fe]"}},
            {"https://[::1]/path", {.yaml = "", .resolved = "https://[::1]"}},
            {"http://[::ffff:a9fe:a9fe]/latest/meta-data/",
                {.yaml = "", .resolved = "http://[::ffff:a9fe:a9fe]"}},
            {"http://[0:0:0:0:0:ffff:a9fe:a9fe]/latest/meta-data/",
                {.yaml = "", .resolved = "http://[0:0:0:0:0:ffff:a9fe:a9fe]"}},
            // Forbidden Domain
            {"https://blabla.burpcollaborator.net/path",
                {.yaml = "", .resolved = "https://blabla.burpcollaborator.net"}},
            {"https://localhost/path", {.yaml = "", .resolved = "https://localhost"}},
            {"https://server.local", {.yaml = "", .resolved = "https://server.local"}},
            {"https://server.internal/common", {.yaml = "", .resolved = "https://server.internal"}},
            {"https://metadata.google/whatever",
                {.yaml = "", .resolved = "https://metadata.google"}},
            {"https://ram.aliyuncs.com", {.yaml = "", .resolved = "https://ram.aliyuncs.com"}},
            {"https://ifconfig.pro", {.yaml = "", .resolved = "https://ifconfig.pro"}},
            {"https://home.localhost.me", {.yaml = "", .resolved = "https://home.localhost.me"}},
            {"https://localhost.me", {.yaml = "", .resolved = "https://localhost.me"}},
            {"http://localhost/", {.yaml = "", .resolved = "http://localhost"}},
            // Non-allowed scheme
            {"gopher://example.com/", {.yaml = "", .resolved = "gopher://example.com"}},
            {"data://google.com/search", {.yaml = "", .resolved = "data://google.com"}},
        },
