...
TEST(TestParserV3, ParseRule)
{
    ...
    ddwaf::parser::v3::parser p(info, mb, dispatcher, limits);
...
TEST(TestParserV3, ParseRuleWithoutType)
{
    ruleset_info info;
    manifest_builder mb;
    rule_data::dispatcher dispatcher;
...
TEST(TestParserV3, ParseRuleWithoutID)
{
    ruleset_info info;
    manifest_builder mb;
    rule_data::dispatcher dispatcher;
...
TEST(TestParserV3, ParseMultipleRules)
{
    ruleset_info info;
    manifest_builder mb;
    rule_data::dispatcher dispatcher;
...
TEST(TestParserV3, ParseMultipleRulesOneInvalid)
{
    ruleset_info info;
    manifest_builder mb;
    rule_data::dispatcher dispatcher;
...
TEST(TestParserV3, ParseRuleOverride)
{
    ruleset_info info;
    manifest_builder mb;
    rule_data::dispatcher dispatcher;
...
TEST(TestParserV3, ParseMultipleRuleOverrides)
{
    ruleset_info info;
    manifest_builder mb;
    rule_data::dispatcher dispatcher;
...
TEST(TestParserV3, ParseInconsistentRuleOverride)
{
    ruleset_info info;
    manifest_builder mb;
    rule_data::dispatcher dispatcher;
