...
TEST(TestCustomRulesIntegration, InitWithoutBaseRules)
{
...

    {
        ...
        EXPECT_EQ(ddwaf_context_eval(context1, &parameter, true, nullptr, LONG_TIME), DDWAF_MATCH);
    }
...
TEST(TestCustomRulesIntegration, UpdateFromBaseRules)
{
...

    {
        ...
        ddwaf_object res;
        EXPECT_EQ(ddwaf_context_eval(context2, &parameter, true, &res, LONG_TIME), DDWAF_MATCH);
...
TEST(TestCustomRulesIntegration, CustomRulesUnaffectedByOverridesAfterUpdate)
{
...

    {
        ...
        ddwaf_object res;
        EXPECT_EQ(ddwaf_context_eval(context3, &parameter, true, &res, LONG_TIME), DDWAF_MATCH);
