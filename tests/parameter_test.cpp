...
TEST(TestParameter, ToUint64)
{
...

    {
        ...
        EXPECT_THROW(
            static_cast<uint64_t>(ddwaf::parameter(root)),
            ddwaf::bad_cast
        );
    }
}
...
TEST(TestParameter, ToString)
{
...

    {
        ...
        EXPECT_THROW(
            static_cast<std::string>(ddwaf::parameter(root)),
            ddwaf::bad_cast
        );
    }
}
...
TEST(TestParameter, ToStringView)
{
...

    {
        ...
        EXPECT_THROW(
            static_cast<std::string_view>(ddwaf::parameter(root)),
            ddwaf::bad_cast
        );
    }
}
...
TEST(TestParameter, ToVector)
{
...

    {
        ...
        EXPECT_THROW(
            static_cast<ddwaf::parameter::vector>(ddwaf::parameter(root)),
            ddwaf::bad_cast
        );
    }
}
...
TEST(TestParameter, ToMap)
{
...

    {
        ...
        EXPECT_THROW(
            static_cast<ddwaf::parameter::map>(ddwaf::parameter(root)),
            ddwaf::bad_cast
        );
    }
}
...
{
    {
        ...
        unsigned i = 0;
        for (auto &param : vec_param) {
            EXPECT_STREQ(param.c_str(), std::to_string(i++).c_str());
        }
...

    {
        ...
        EXPECT_THROW(
            static_cast<std::vector<std::string>>(ddwaf::parameter(root)),
...
{
    {
        ...
        unsigned i = 0;
        for (auto &param : vec_param) {
            EXPECT_STREQ(param.data(), std::to_string(i++).c_str());
        }
...

    {
        ...
        EXPECT_THROW(
            static_cast<std::vector<std::string_view>>(ddwaf::parameter(root)),
            ddwaf::malformed_object
        );
...
TEST(TestParameter, ToStringViewSet)
{
...

    {
        ...
        EXPECT_THROW(
            static_cast<ddwaf::parameter::string_set>(ddwaf::parameter(root)),
            ddwaf::malformed_object
        );
