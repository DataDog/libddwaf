...
{
    sqli_detector cond{{gen_param_def("server.db.statement", "server.request.query", "server.db.statement")}};
    ...
    ddwaf_object_map_add(&root, "server.db.system", ddwaf_object_stringl(&tmp, dialect_str.data(), dialect_str.size()));
